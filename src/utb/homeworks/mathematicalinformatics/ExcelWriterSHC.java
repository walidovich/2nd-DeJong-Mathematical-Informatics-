...
public class ExcelWriterSHC {
	...
	final String excelFileName = "2nd DeJong.xlsx";
	final String SHC_Sheet = "2nd DJ SHC";
	...
	private void writeInCells() {
		...
		int i = 6;
		wb.getSheetAt(0).createRow(i++).createCell(0).setCellValue("2nd DeJong SHC results:");
		i = 8;
